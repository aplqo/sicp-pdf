...
\documentclass[fontsize=11pt,open=any,paper=A4,DIV=13,BCOR=12mm]{scrbook}
...
\setmonofont{Cascadia Code}                            %  to turn out curly
                                                       %  ("typographic")
...
\definecolor{MyBlue}{HTML}{0077AF}
\hypersetup{
...
\renewcommand{\LettrineFontHook}{\rmfamily\mdseries\color{MyBlue}}
...
\titleformat{\chapter}[display]
  ...
  {\filright \color{MyBlue}\sffamily\mdseries
...
{\color{MyBlue}\thesection}{0.8em}{}

\titleformat{\subsection}
{\color{MyBlue}\normalfont\large\sffamily\bfseries}
{\color{MyBlue}\thesubsection}{0.8em}{}
